 ...
 *
 * Ready to print track parts: a set of male barrier chunks for a large curved track section.
 *
 * @author jsconan
 */
...
applyMode(mode=renderMode) {
    ...
    outerCurveBarrierMaleSet(ratio=ratio, quantity=outerCurveChunks, line=printQuantity);
